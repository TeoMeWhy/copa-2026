...
SELECT 
        ...
        t2.avgLoserMatches,
        t2.avgWorldCupScore,
        t2.avgWorldCupAwayScore,
        t2.avgWorldCupBalanceScore,
        t2.avgWorldCupWinnerMatches,
        t2.avgWorldCupLoserMatches,
        t2.avgWorldCupQualificationScore,
        t2.avgWorldCupQualificationAwayScore,
        t2.avgWorldCupQualificationBalanceScore,
        t2.avgWorldCupQualificationWinnerMatches,
        t2.avgWorldCupQualificationLoserMatches,
       t2.qtdWorldCup,
